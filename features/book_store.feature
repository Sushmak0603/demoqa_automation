Feature: Book Store Application testing
  ...
  Scenario: Look at the list of books and use the api to validate the correctness of the data displayed on the book store page (TC008)
    Then the user navigates to "Book Store" section under "Book Store Application"
    And the user selects "20" in the row per page dropdown
